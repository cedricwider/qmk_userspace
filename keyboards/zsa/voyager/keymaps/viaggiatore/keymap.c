...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_voyager(
    ...
    MEH_TAP,        KC_W,           KC_L,           KC_R,           KC_B,           KC_Z,                                           KC_SCLN,        KC_Q,           KC_U,           KC_D,           KC_J,           MEH_BSL,
  ...
  [_NAV] = LAYOUT_voyager(
    ...
    KC_DELETE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_LPRN,        KC_RPRN,        KC_TRANSPARENT,                                 KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_ESCAPE,      KC_TRANSPARENT,
  ...
  [_NUMERIC] = LAYOUT_voyager(
    ...
    KC_DELETE,      KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_4,           KC_5,           KC_6,           KC_EQUAL,       KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                               KC_0,           KC_1,           KC_2,           KC_3,           KC_COMMA,       KC_ENTER,
                                                                    TO(_BASE),      TO(_BASE),                                      KC_TRANSPARENT, KC_0
  ),
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    //_BASE
    [0] = {
        {170,94,27}, {170,94,27}, {170,94,27}, {170,94,27}, {170,94,27}, {170,94,27},
        {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146},
        {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146},
        {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146},
                                                                {169,255,84}, {154,215,175},

        {170,94,27},  {170,94,27},  {170,94,27},  {170,94,27},  {170,94,27},  {170,94,27},
        {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146},
        {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146},
        {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146}, {170,89,146},
        {82,250,227},  {169,255,84}
    },

    //_LOWER
    [1] = {
        {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175},
        {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175},
        {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175},
        {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175}, {154,215,175},
                                                                    {154,215,175}, {154,215,175},
    ...
    //_RAISE
    [2] = {
        {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227},
        {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227},
        {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227},
        {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227}, {82,250,227},
                                                                {82,250,227}, {82,250,227},
    ...
    //_NUMERIC
    [4] = {
        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
                                                                    {243,109,243},   {243,109,243},

        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243},   {41,255,255},  {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},   {243,109,243},
        {243,109,243},   {243,109,243}
    },
