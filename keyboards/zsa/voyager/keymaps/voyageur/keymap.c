...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    CW_TOGG,        KC_F,           KC_M,           KC_V,           KC_C,           KC_SLASH,                                       KC_G,           KC_P,           KC_X,           KC_K,           KC_Y,           MT(MOD_LSFT, KC_ENTER),
                                                    LT(1,KC_MINUS), LT(4,KC_ENTER),                                 LT(4,KC_ENTER), LT(2,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
  ...
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, LALT(LCTL(LSFT(KC_1))),LALT(LCTL(LSFT(KC_2))),LALT(LCTL(LSFT(KC_3))),LALT(LCTL(LSFT(KC_4))),LALT(LCTL(LSFT(KC_5))),                                LALT(LCTL(LSFT(KC_6))),LALT(LCTL(LSFT(KC_7))),LALT(LCTL(LSFT(KC_8))),LALT(LCTL(LSFT(KC_9))),LALT(LCTL(LSFT(KC_0))),KC_TRANSPARENT,
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [0] = { {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {96,230,217}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {96,230,217}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {96,230,217}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {96,230,217}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {96,230,217}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {139,214,152}, {96,230,217}, {96,230,217}, {96,230,217} },
