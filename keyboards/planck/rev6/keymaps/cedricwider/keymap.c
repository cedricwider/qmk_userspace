...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, TO(_BASE), _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, TO(_BASE), _______, _______, TG(_NUMSYM),    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
